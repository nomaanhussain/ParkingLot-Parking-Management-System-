...
public partial class ForgotPassword : System.Web.UI.Page
{
    ...
    protected void btPassRec_Click(object sender, EventArgs e)
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select * FROM [parkinglot].[dbo].[user] where [email]='" + tbEmailId.Text + "'", con);
            con.Open();
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                SqlCommand cmd1 = new SqlCommand("INSERT INTO [parkinglot].[dbo].[ForgotPassRequests] values('" + myGUID + "','" + Uid + "',getdate())", con);
                cmd1.ExecuteNonQuery();

                  //send email
                  String ToEmailAddress = dt.Rows[0][3].ToString();
                  String Username = dt.Rows[0][1].ToString();
                  String EmailBody = "Hi " + Username + ",<br/><br/> Click the link below to reset your password <br/><br/> http://localhost:22939/RecoverPassword.aspx?Uid=" + myGUID;
